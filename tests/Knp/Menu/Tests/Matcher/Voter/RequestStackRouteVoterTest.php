...
use Knp\Menu\Matcher\Voter\RequestStackRouteVoter;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\RequestStack;

class RequestStackRouteVoterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInvalidRouteConfig()
    {
        ...
        $voter = new RequestStackRouteVoter($requestStack);
